...
static inline void uni_begin(void)
{
  if (strip)
    strip->begin();
}
static inline void uni_show(void)
{
  if (strip)
    strip->show();
}
...
#define SOC_GPIO_PIN_STATUS (hw_info.model == SOFTRF_MODEL_MIDI ? SOC_GPIO_PIN_HELTRK_LED : hw_info.model == SOFTRF_MODEL_ECO                                                ? SOC_GPIO_PIN_T3C6_LED     \
                                                                                        : hw_info.model == SOFTRF_MODEL_INK                                                  ? SOC_GPIO_PIN_T3S3_LED     \
                                                                                        : hw_info.model == SOFTRF_MODEL_STANDALONE && hw_info.revision == STD_EDN_REV_BPICOW ? SOC_GPIO_PIN_BPIPW_STATUS \
                                                                                        : hw_info.model == SOFTRF_MODEL_GIZMO                                                ? SOC_GPIO_PIN_M2_LED       \
                                                                                        : hw_info.model == SOFTRF_MODEL_NANO && hw_info.revision == 1                        ? SOC_GPIO_PIN_ELRS_LED     \
                                                                                        : hw_info.model != SOFTRF_MODEL_PRIME_MK2                                            ? SOC_UNUSED_PIN            \
                                                                                                                                                                             : (hw_info.revision == 2 ? SOC_GPIO_PIN_TBEAM_LED_V02 : (hw_info.revision == 5 ? SOC_GPIO_PIN_TBEAM_LED_V05 : (hw_info.revision == 11 ? SOC_GPIO_PIN_TBEAM_LED_V11 : SOC_UNUSED_PIN))))

#define SOC_GPIO_PIN_GNSS_PPS (hw_info.model == SOFTRF_MODEL_PRIME_MK3 ? SOC_GPIO_PIN_S3_GNSS_PPS : (hw_info.model == SOFTRF_MODEL_PRIME_MK2 ? (hw_info.revision >= 8 ? SOC_GPIO_PIN_TBEAM_V08_PPS : SOC_UNUSED_PIN) : (hw_info.model == SOFTRF_MODEL_MIDI ? SOC_GPIO_PIN_HELTRK_GNSS_PPS : (hw_info.model == SOFTRF_MODEL_ECO ? SOC_GPIO_PIN_T3C6_GNSS_PPS : (hw_info.model == SOFTRF_MODEL_INK ? SOC_GPIO_PIN_T3S3_GNSS_PPS : (hw_info.model == SOFTRF_MODEL_GIZMO ? SOC_GPIO_PIN_M2_GNSS_PPS : (hw_info.model == SOFTRF_MODEL_STANDALONE && hw_info.revision == STD_EDN_REV_WT99P4C5 ? SOC_GPIO_PIN_P4_GNSS_PPS : SOC_UNUSED_PIN)))))))

#define SOC_GPIO_PIN_BUZZER (hw_info.model == SOFTRF_MODEL_PRIME_MK2 ? SOC_UNUSED_PIN : (esp32_board == ESP32_DEVKIT ? 13 : (esp32_board == ESP32_C3_DEVKIT ? SOC_GPIO_PIN_C3_BUZZER : (esp32_board == ESP32_C6_DEVKIT ? SOC_GPIO_PIN_C6_BUZZER : (esp32_board == ESP32_BANANA_PICOW ? SOC_GPIO_PIN_BPIPW_BUZZER : (esp32_board == ESP32_ELECROW_TN_M2 ? SOC_GPIO_PIN_M2_BUZZER : (esp32_board == ESP32_ELECROW_TN_M5 ? SOC_GPIO_PIN_M5_BUZZER : (esp32_board == ESP32_P4_WT_DEVKIT ? SOC_GPIO_PIN_P4_BUZZER : SOC_UNUSED_PIN))))))))
...
#define POWER_SAVING_WIFI_TIMEOUT 180000UL /* 180 seconds */
